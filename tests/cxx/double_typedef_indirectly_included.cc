...
#include "double_typedef_indirectly_included.h"
#include "double_typedef_indirectly_included-i.h"
#include <memory>

void foo()
{
    ClassSPtr obj = std::make_shared<Class>();
    SomethingElse something;
}

/**** IWYU_SUMMARY
(tests/cxx/double_typedef_indirectly_included.cc has correct #includes/fwd-decls)
***** IWYU_SUMMARY */
